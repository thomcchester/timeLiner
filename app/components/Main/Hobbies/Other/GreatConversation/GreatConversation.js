...
import GreatConversationStore from './GreatConversationStore.js';
import GreatConversationActions from './GreatConversationActions.js';
class GreatConversation extends React.Component {

	constructor(props) {
		super(props);
		this.state = GreatConversationStore.getState();
		this.onChange = this.onChange.bind(this);
	}

	componentDidMount() {
		GreatConversationStore.listen(this.onChange);
	}
...
render() {
		...
		return (
			{/*
			<div>
				<h1>Great Conversation</h1>
				<p> Simply Nothing Better</p>
			</div>
			*/},
 ...
 export default GreatConversation
